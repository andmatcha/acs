...
use crate::output::formats::{DummyPayloadGenerator, MixedFormatDecoder};
...
mod tests {
    use super::{
        ...
        IoPromptPortPosition, IoRuntimeOptions, ObservedInput, OutputSchedule,
        build_io_executed_command, estimated_output_line_bps, format_io_input_binding,
        format_io_output_binding, parse_io_args, parse_io_input_binding, parse_io_output_binding,
    ...
    use crate::output::formats::{
        MixedFormatDecoder, matches_reduced_ac_packet, matches_rover_down_packet,
    };
